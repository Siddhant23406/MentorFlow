...
const problemDescription = "Two Sum: find two numbers that add up to a target";
const studentMessage = "I'll use a hash map — for each number, check if target minus that number is already in the map, if so return the pair, otherwise add it to the map";
